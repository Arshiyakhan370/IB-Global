...
const AuthenticationForm = () => {
  ...
  return (
    <div classNameName="section-right max-w-md w-[100%] mt-8 bg-gray-100 rounded-md md:w-[100%] md:pr-8 md:pl-8">
      ...
      {isV1 && <div classNameName='flex items-center justify-between mt-4'>
